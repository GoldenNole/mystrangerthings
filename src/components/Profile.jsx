  ...
  return (
    <div>
      ...
      <div className="main-container">
        <h1> Welcome {user}! </h1>
        <h1> My Posts </h1>
        {userPosts.length === 0 && <div className="container"><h2>You have not posted anything!</h2></div>}
        {userPosts &&
          userPosts.map((post) => (
            <div key={post._id}>
        ...
        <h1> My Messages </h1>
        {userMessages.length === 0 && <div className="container"><h2>You have not messaged anyone!</h2></div>}
        {userMessages &&
